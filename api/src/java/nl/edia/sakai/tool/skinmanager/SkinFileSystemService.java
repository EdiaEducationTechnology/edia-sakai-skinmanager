...
/**
 * The SkinFileSystemService interface defines the skin manager server.
 * Although backed by the filesystem, it reflects as much as possible
 * any other presistent API.
 * @author Roland
 *
 */
