	...
	<div class="portletBody">
		<div class="navIntraTool">
			<est:allowed permission="skinmanager.edit">
				<a href="${flowExecutionUrl}&amp;_eventId=update"><spring:message  code="page.detail.action.update"/></a>
			</est:allowed>
			<est:allowed permission="skinmanager.delete">
				<a href="${flowExecutionUrl}&amp;_eventId=delete"><spring:message  code="page.detail.action.delete"/></a>
			</est:allowed>
			<a href="${flowExecutionUrl}&amp;_eventId=history"><spring:message  code="page.detail.action.history"/></a>
		</div>
